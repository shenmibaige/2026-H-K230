 ...
 *
 * v3.2 26 s trace: scale the verified 16 s profile by 16/26.
 *   Speed PWM, PID authority, slew rate and elapsed-time stages are scaled
 *   together so the path shape stays the same while the lap is slower.
 */
...
#define CURVE_START_RAMP_MS                 500U
#define CURVE_FINISH_ARM_MIN_MS             3250U
#define CURVE_FINISH_APPROACH_STAGE1_MS     19500U
#define CURVE_FINISH_APPROACH_STAGE2_MS     22750U
#define CURVE_HARD_TIMEOUT_MS               32000U
#define CURVE_FINISH_STOP_DELAY_MS          2000U
 ...
 */
#define CURVE_LINE_PID_KP                   0.30f
#define CURVE_LINE_PID_KI                   0.006f
#define CURVE_LINE_PID_KD                   0.15f
#define CURVE_LINE_PID_I_OUT_LIMIT          9.0f
#define CURVE_LINE_PID_OUT_LIMIT            32.0f

#define CURVE_ERROR_NEAR_Q8                 (15 * CURVE_Q8_SCALE / 2)
#define CURVE_ERROR_MID_Q8                  (45 * CURVE_Q8_SCALE / 2)
#define CURVE_BASE_STRAIGHT_PWM             60
#define CURVE_BASE_MID_PWM                  49
#define CURVE_BASE_OUTER_PWM                40

/* 19.5-22.75 s first approach stage. */
#define CURVE_APPROACH1_STRAIGHT_PWM        50
#define CURVE_APPROACH1_MID_PWM             43
#define CURVE_APPROACH1_OUTER_PWM           36

/* >=22.75 s final approach stage. */
#define CURVE_APPROACH2_STRAIGHT_PWM        37
#define CURVE_APPROACH2_MID_PWM             33
#define CURVE_APPROACH2_OUTER_PWM           28

#define CURVE_PWM_LIMIT                     62
#define CURVE_PWM_RISE_PER_5MS              3
#define CURVE_PWM_FALL_PER_5MS              5
